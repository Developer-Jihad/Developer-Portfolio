        ...
        <div className="py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
              ...
              <ul className="space-y-4">
                {navigationLinks.map((link) => (
                  ...
                  >
                    ...
                    >
                      <span className="h-px w-4 bg-white/20 group-hover:w-6 group-hover:bg-white/60 
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {['Web Development', 'UI/UX Design', 'Mobile Development', 'API Integration'].map((service) => (
                  <motion.li 
                    key={service}
                    whileHover={{ x: 6 }}
                    transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  >
                    <span className="text-white/60 hover:text-white transition-colors duration-300 flex 
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                ...
                >
                  ...
                  <a href="mailto:jihad.developer.bd@gmail.com" 
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/60 text-sm">
              © {new Date().getFullYear()} Jihad. All rights reserved.
            </p>
